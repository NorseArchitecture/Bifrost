...
| `BlazingStory.ProjectTemplates` | `blazingstoryserver`, `blazingstorywasm`, `bstories` | Scaffolds a Storybook-style catalog app for Blazor components, plus individual story files. Candidate for previewing Naglfar (`Norse.DesignSystem.*`) tokens/components once a component library is decided. |
